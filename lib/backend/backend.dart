...
/// Functions to query NpsMetricsRecords (as a Stream and as a Future).
Future<int> queryNpsMetricsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      NpsMetricsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NpsMetricsRecord>> queryNpsMetricsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      NpsMetricsRecord.collection,
      NpsMetricsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NpsMetricsRecord>> queryNpsMetricsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query GreetingsForAIPromptRecords (as a Stream and as a Future).
Future<int> queryGreetingsForAIPromptRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<GreetingsForAIPromptRecord>> queryGreetingsForAIPromptRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<GreetingsForAIPromptRecord>> queryGreetingsForAIPromptRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
