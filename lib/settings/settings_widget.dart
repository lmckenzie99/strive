...
/// generate me a settings page with the background and color scheme I have
/// used on my other pages that has a link bank buttom, a reset password
/// button, an AI response type button  and a UI settings button with a
/// hamburger menu option in the upper left hand corner.
///
/// The strive logo should also be at the top center
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(15.0, 24.0, 0.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                      ...
                      Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              await actions.openPlaidLink(
                                'link-sandbox-a7ed3f73-e985-481d-82d5-5e51217f1573',
                              );
                            },
                            child: Container(
