...
class _AddGoalWidgetState extends State<AddGoalWidget> {
  ...
  void initState() {
    ...
    _model.titlesTextController ??= TextEditingController();
    _model.titlesFocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: double.infinity,
              child: TextFormField(
                controller: _model.titlesTextController,
                focusNode: _model.titlesFocusNode,
                autofocus: false,
                enabled: true,
                obscureText: false,
                ...
                validator:
                    _model.titlesTextControllerValidator.asValidator(context),
              ),
            ),
            Container(
              width: double.infinity,
              ...
              onPressed: () async {
                await GoalsRecord.collection.doc().set(createGoalsRecordData(
                      title: valueOrDefault<String>(
                        _model.titlesTextController.text,
                        'Title',
                      ),
